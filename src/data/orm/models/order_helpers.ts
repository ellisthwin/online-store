...
const primaryKey = { type: DataTypes.INTEGER, autoIncrement: true, primaryKey: true};
...
export const initializeOrderModels = (sequelize: Sequelize) => {
    ...
    ProductSelectionModel.init({
        ...primaryKey, quantity: DataTypes.INTEGER, price: DataTypes.DECIMAL(10, 2)
    }, {sequelize});

    AddressModel.init({
        ...primaryKey, street: DataTypes.STRING, city: DataTypes.STRING, state: DataTypes.STRING, zip: DataTypes.STRING,
    }, {sequelize});
